...
while cap.isOpened():
    ...
    for ps in psObjs:
        ...
        cv2.polylines(frame, [np.array(ps.vertices, np.int32)], True, color, 3)
...
if last_frame is not None:
    save_path = os.path.join(os.path.dirname(__file__), 'last_frame3.png')
...
with open('detection3.pkl', 'wb') as f:
